    ...
    try {
        ...
        if (parseInt(wordsCount.rows[0].count) === 0) {
            const words = [
                ...
                ['носорог', 'животные', 3], ['бегемот', 'животные', 3], ['тарантул', 'животные', 3], ['хамелеон', 'животные', 3],
                ['броненосец', 'животные', 3], ['ехидна', 'животные', 3], ['лемур', 'животные', 3], ['скорпион', 'животные', 3],
                ...
                ['авокадо', 'еда', 3], ['артишок', 'еда', 3], ['брокколи', 'еда', 3], ['спаржа', 'еда', 3],
                ['гранат', 'еда', 3], ['папайя', 'еда', 3], ['киви', 'еда', 3], ['манго', 'еда', 3],
                ...
                ['регби', 'спорт', 3], ['крикет', 'спорт', 3], ['керлинг', 'спорт', 3], ['биатлон', 'спорт', 3],
                ['фехтование', 'спорт', 3], ['конкур', 'спорт', 3], ['гольф', 'спорт', 3], ['бадминтон', 'спорт', 3],
                ...
                ['дирижабль', 'транспорт', 3], ['подводная лодка', 'транспорт', 3], ['монорельс', 'транспорт', 3], ['снегоход', 'транспорт', 3],
                ['гидроплан', 'транспорт', 3], ['тележка', 'транспорт', 3], ['паром', 'транспорт', 3], ['эскалатор', 'транспорт', 3],
                ...
                ['архитектор', 'профессии', 3], ['ветеринар', 'профессии', 3], ['археолог', 'профессии', 3], ['дипломат', 'профессии', 3],
                ['скульптор', 'профессии', 3], ['фармацевт', 'профессии', 3], ['нейрохирург', 'профессии', 3], ['геолог', 'профессии', 3],
                ...
                ['арфа', 'музыка', 3], ['виолончель', 'музыка', 3], ['аккордеон', 'музыка', 3], ['контрабас', 'музыка', 3],
                ['кларнет', 'музыка', 3], ['ксилофон', 'музыка', 3], ['тромбон', 'музыка', 3], ['балалайка', 'музыка', 3],
                ...
                ['проектор', 'технологии', 3], ['сканер', 'технологии', 3], ['стереосистема', 'технологии', 3], ['синтезатор', 'технологии', 3],
                ['биометрия', 'технологии', 3], ['голограмма', 'технологии', 3], ['навигатор', 'технологии', 3], ['модем', 'технологии', 3],
                ...
                ['ностальгия', 'эмоции', 3], ['меланхолия', 'эмоции', 3], ['эйфория', 'эмоции', 3], ['апатия', 'эмоции', 3],
                ['умиление', 'эмоции', 3], ['предвкушение', 'эмоции', 3], ['смущение', 'эмоции', 3], ['восхищение', 'эмоции', 3],
                ...
                ['обсерватория', 'места', 3], ['планетарий', 'места', 3], ['аквариум', 'места', 3], ['мавзолей', 'места', 3],
                ['консерватория', 'места', 3], ['ипподром', 'места', 3], ['лаборатория', 'места', 3], ['оранжерея', 'места', 3],
                ...
                ['землетрясение', 'природа', 3], ['извержение', 'природа', 3], ['цунами', 'природа', 3], ['торнадо', 'природа', 3],
                ['лавина', 'природа', 3], ['затмение', 'природа', 3], ['северное сияние', 'природа', 3], ['метеорит', 'природа', 3],
                ...
                ['медитация', 'действия', 3], ['жонглирование', 'действия', 3], ['кувырок', 'действия', 3], ['сальто', 'действия', 3],
                ['скалолазание', 'действия', 3], ['парашютизм', 'действия', 3], ['дайвинг', 'действия', 3], ['серфинг', 'действия', 3],
                ...
                ['бирюзовый', 'цвета', 3], ['малиновый', 'цвета', 3], ['изумрудный', 'цвета', 3], ['лиловый', 'цвета', 3],
                ['коралловый', 'цвета', 3], ['бордовый', 'цвета', 3], ['бежевый', 'цвета', 3], ['салатовый', 'цвета', 3],
                ...
                ['кентавр', 'сказки', 3], ['минотавр', 'сказки', 3], ['феникс', 'сказки', 3], ['химера', 'сказки', 3],
                ['василиск', 'сказки', 3], ['грифон', 'сказки', 3], ['русалка', 'сказки', 3], ['циклоп', 'сказки', 3],
                ...
                ['смокинг', 'одежда', 3], ['фрак', 'одежда', 3], ['сарафан', 'одежда', 3], ['кимоно', 'одежда', 3],
                ['галстук-бабочка', 'одежда', 3], ['запонки', 'одежда', 3], ['жилет', 'одежда', 3], ['манжеты', 'одежда', 3],

                ['кровать', 'мебель', 1], ['стол', 'мебель', 1], ['стул', 'мебель', 1], ['диван', 'мебель', 1],
                ['шкаф', 'мебель', 1], ['кресло', 'мебель', 1], ['полка', 'мебель', 1], ['комод', 'мебель', 2],
                ['секретер', 'мебель', 3], ['буфет', 'мебель', 3], ['консоль', 'мебель', 3], ['этажерка', 'мебель', 3],
                ['трюмо', 'мебель', 3], ['софа', 'мебель', 3], ['пуфик', 'мебель', 3], ['табурет', 'мебель', 3],
                ...
                ['компас', 'предметы', 3], ['бинокль', 'предметы', 3], ['микроскоп', 'предметы', 3], ['телескоп', 'предметы', 3],
                ['штопор', 'предметы', 3], ['циркуль', 'предметы', 3], ['транспортир', 'предметы', 3], ['линейка', 'предметы', 3]
            ];
...
/removeword слово
/updatecrocodiledb - обновить базу слов (полная замена)
...
bot.onText(/^\/updatecrocodiledb$/i, async (msg) => {
    ...
    try {
        ...
        await client.query('DELETE FROM crocodile_words');
        ...
        bot.sendMessage(chatId, `✅ База слов обновлена!\n\n📊 Добавлено слов: ${added}\n🔄 История использованных слов очищена для всех чатов.`);
    } catch (error) {
        bot.sendMessage(chatId, `❌ Ошибка обновления базы: ${error.message}`);
    } finally {
        client.release();
    }
});
